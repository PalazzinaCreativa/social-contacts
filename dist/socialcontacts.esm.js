...
var __vue_staticRenderFns__$6 = [];
  ...
  var __vue_inject_styles__$6 = function (inject) {
    if (!inject) { return }
    inject("data-v-06fe8a44_0", { source: ".social-links[data-v-06fe8a44]{display:flex;align-items:center;position:relative;width:100%}.social-links .social[data-v-06fe8a44]{display:flex;box-sizing:border-box;justify-content:center;align-items:center;position:relative;width:3rem;height:3rem;padding:.875rem;margin:0 .75rem}.social-links .social[data-v-06fe8a44]:first-child{margin-left:0}.social-links .social[data-v-06fe8a44]:last-child{margin-right:0}.social-links .social__bg[data-v-06fe8a44]{background-color:var(--bg-color);width:100%;height:100%;position:absolute;top:0;border-radius:50%;left:0;transition:transform .6s ease-out}.social-links .social__icon[data-v-06fe8a44]{position:relative;z-index:4;display:flex;justify-content:center;align-items:center;width:100%;height:100%;color:var(--icon-color)}.social-links .social__icon[data-v-06fe8a44]  svg{width:auto;height:100%}.social-links .social:hover .social__bg[data-v-06fe8a44]{transform:scale(1.1)}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$6 = "data-v-06fe8a44";
  /* module identifier */
